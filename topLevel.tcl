...
read_verilog -library xil_defaultlib -sv [ glob ../ch_unit/src/*.sv ]
read_verilog -library xil_defaultlib [ glob ../ch_unit/src/sampleIP_tl.v ]
...
source ../bd/bd.tcl
generate_target all [get_files  ../bd/design_1/design_1.bd]
read_verilog -library xil_defaultlib [ glob ../bd/design_1/hdl/design_1_wrapper.v ]  
